...
```sh
docker tag <image-id> dogan2010/regapp:tagname
docker push dogan2010/regapp:tagname
```
...
```sh
eksctl delete cluster --name dogan-cluster
```
...
```sh
kubectl delete deploy dogan-regapp
kubectl delete service dogan-service
```
